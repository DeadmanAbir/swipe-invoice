...
**Swipe Invoice Extractor**,  is an open-source AI tool which can extract user data from any type of invoice. Supporting different formats for now such as  Ppt, Docx, images, pdf etc.
